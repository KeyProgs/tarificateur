...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $.fn.stepy.defaults.backLabel = '<i class="icon-arrow-left13 position-left"></i> Retoure';
    $.fn.stepy.defaults.nextLabel = 'Suivant <i class="icon-arrow-right14 position-right"></i>';
