...
<head>
    ...
    <!-- Theme JS files -->
    <script src="{{asset('global-assets/js/plugins/visualization/d3/d3.min.js')}}"></script>
    <script src="{{asset('global-assets/js/plugins/visualization/d3/d3_tooltip.js')}}"></script>
    <script src="{{asset('global-assets/js/plugins/forms/styling/switchery.min.js')}}"></script>
    <script src="{{asset('global-assets/js/plugins/forms/selects/bootstrap_multiselect.js')}}"></script>
    <script src="{{asset('global-assets/js/plugins/ui/moment/moment.min.js')}}"></script>
    <script src="{{asset('global-assets/js/plugins/pickers/daterangepicker.js')}}"></script>

    <script src="{{asset('js/limitless.js')}}"></script>
    <script src="{{asset('js/main.js')}}"></script>
    <script src="{{asset('global-assets/js/demo_pages/dashboard.js')}}"></script>
...
<!-- Main navbar -->
<div class="navbar navbar-inverse bg-grey-600 navbar-static-top">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-content width-350">
                        ...
                        <ul class="media-list dropdown-content-body">
                            <li class="media">
                                <div class="media-left">
                                    <img src="global-assets/images/placeholders/placeholder.jpg" class="img-circle img-sm" alt="">
                            ...
                            <li class="media">
                                <div class="media-left"><img src="global-assets/images/placeholders/placeholder.jpg" class="img-circle img-sm" alt=""></div>
                                <div class="media-body">
                                    <a href="#" class="media-heading">
                ...
                <div class="sidebar-user-material">
                    <div class="category-content">
                        <div class="sidebar-user-material-content">
                            <a href="#"><img src="global-assets/images/placeholders/placeholder.jpg" class="img-circle img-responsive" alt=""></a>
                    ...
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="../../../../layout_1/LTR/material/full/index.html" id="layout1">Layout 1 <span class="label bg-warning-400">Current</span></a></li>
                                    <li><a href="../../../../layout_2/LTR/material/full/index.html" id="layout2">Layout 2</a></li>
                                    <li><a href="../../../../layout_3/LTR/material/full/index.html" id="layout3">Layout 3</a></li>
                                    <li><a href="../../../../layout_4/LTR/material/full/index.html" id="layout4">Layout 4</a></li>
                                    <li><a href="../../../../layout_5/LTR/material/full/index.html" id="layout5">Layout 5</a></li>
                                    <li class="disabled"><a href="../../../../layout_6/LTR/material/full/index.html" id="layout6">Layout 6 <span class="label label-transparent">Coming soon</span></a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-left media-middle">
                                                <a href="#"><img src="global-assets/images/brands/facebook.png" class="img-circle img-xs" alt=""></a>
                                            </div>
                                            <div class="media-left">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-left media-middle">
                                                <a href="#"><img src="global-assets/images/brands/youtube.png" class="img-circle img-xs" alt=""></a>
                                            </div>
                                            <div class="media-left">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-left media-middle">
                                                <a href="#"><img src="global-assets/images/brands/spotify.png" class="img-circle img-xs" alt=""></a>
                                            </div>
                                            <div class="media-left">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-left media-middle">
                                                <a href="#"><img src="global-assets/images/brands/twitter.png" class="img-circle img-xs" alt=""></a>
                                            </div>
                                            <div class="media-left">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-left media-middle">
                                                <a href="#"><img src="global-assets/images/brands/bing.png" class="img-circle img-xs" alt=""></a>
                                            </div>
                                            <div class="media-left">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-left media-middle">
                                                <a href="#"><img src="global-assets/images/brands/amazon.png" class="img-circle img-xs" alt=""></a>
                                            </div>
                                            <div class="media-left">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-left media-middle">
                                                <a href="#"><img src="global-assets/images/brands/dribbble.png" class="img-circle img-xs" alt=""></a>
                                            </div>
                                            <div class="media-left">
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media-left media-middle">
                                                <a href="#"><img src="global-assets/images/placeholders/placeholder.jpg" class="img-circle img-xs" alt=""></a>
                                            </div>
                                        ...
                                        <ul class="media-list content-group">
                                            <li class="media stack-media-on-mobile">
                                                <div class="media-left">
                                                    <div class="thumb">
                                                        <a href="#">
                                                            <img src="global-assets/images/placeholders/placeholder.jpg" class="img-responsive img-rounded media-preview" alt="">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active fade in has-padding" id="messages-tue">
                                    <ul class="media-list">
                                        <li class="media">
                                            <div class="media-left">
                                                <img src="global-assets/images/placeholders/placeholder.jpg" class="img-circle img-xs" alt="">
