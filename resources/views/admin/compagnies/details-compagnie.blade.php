...
@section('content')
    ...
    <div class="page-container">
                    ...
                    <div class="col-md-12">
                                ...
                                @forelse($compagnie->gammes as $gamme)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url('/compagnie/'.$compagnie->id.'/gamme/'.$gamme->id)}}" title="Voir les details"><i
                                                        class="icon-eye2"></i> </a>
                                            &nbsp;&nbsp;
                                            <a class="confirm-delete" data-href="{{url('/compagnie/'.$compagnie->id.'/gamme/'.$gamme->id.'/suppression')}}" title="Supprimer"><i class="icon-trash"></i> </a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                        ...
                        <div class="panel panel-flat rounded0">
                            ...
                            <ul class="mail-attachments p-20">
                                @foreach($compagnie->piece_jointes as $piece)
                                    <li>
                                    <span class="mail-attachments-preview">
                                        ...
                                        <div class="mail-attachments-content">
                                            ...
                                            <ul class="list-inline list-inline-condensed no-margin">
                                                ...
                                                <li>
                                                    <a data-type="compagnie" data-type-id="{{$compagnie->id}}"
                                                       data-id="{{$piece->id}}"
                                                       data-href="{{url('/compagnie/'.$compagnie->id.'/piece-jointe/'.$piece->id)}}"
                                                       class="get-file-infos">Voir
                                                        les details</a></li>
                                                <li><a target="_blank" href="{{asset('uploads/pieces-jointes/compagnies/'.$piece->url)}}">Telecharger</a></li>
                                                <li><a target="" class="confirm-delete" title="Supprimer"
                                                       data-href="{{url('/compagnie/'.$compagnie->id.'/piece-jointe/'.$piece->id.'/suppression')}}"><i
        ...
        <!-- /page content -->
        @include('includes.piece-jointe' ,['type' => "compagnie",'type_id'=>$compagnie->id])
    </div>
    <!-- /page container -->
@endsection
