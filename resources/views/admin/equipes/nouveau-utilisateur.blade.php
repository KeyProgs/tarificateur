            ...
            <div class="content-wrapper">
                ...
                <div class="content p0">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form action="{{url('/nouveau-utilisateur')}}" method="post">
                            @csrf
                            ...
                            <div class="panel registration-form">
                                <div class="panel-body">
                                    <div class="text-center">
                                        ...
                                        <h5 class="content-group-lg">Utilisateur informations
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-feedback">
                                                <input type="date" class="form-control" name="date_naissance"
                                                       placeholder="Date Naissance" value="{{old('date_naissance')}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" class="form-control" name="adresse" rows="5"
                                                      placeholder="Adresse" value="">{{old('adresse')}}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-feedback">
                                                <select class="form-control" name="equipe_id[]" id="equipe_id" multiple>
