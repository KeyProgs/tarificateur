        ...
        <!-- Main content -->
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    @endif
                    <form id="equipe_forme" method="post" action="{{url('/nouvelle-equipe')}}">
                    @csrf
                    <!-- equipe Section-->
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <div class="row pt-20">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nom" id="nom"
                                                               class="mt-m15 form-control" value="{{old('nom')}}">
                                                        @if ($errors->has('nom'))
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="adresse1" id="adresse1"
                                                               class="mt-m15 form-control" value="{{old('adresse1')}}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="adresse2" id="adresse2"
                                                               class="mt-m15 form-control" value="{{old('adresse2')}}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="tel1" id="tel1"
                                                               class="mt-m15 form-control" value="{{old('tel1')}}">
                                                        @if ($errors->has('tel1'))
                                                        <span class="text-danger error-msg">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="tel2" id="tel2"
                                                               class="mt-m15 form-control" value="{{old('tel2')}}">
                                                        @if ($errors->has('tel2'))
                                                        <span class="text-danger error-msg">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="tel3" id="tel3"
                                                               class="mt-m15 form-control" value="{{old('tel3')}}">
                                                        @if ($errors->has('tel3'))
                                                        <span class="text-danger error-msg">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="email" id="email"
                                                               class="mt-m15 form-control" value="{{old('email')}}">
                                                        @if ($errors->has('email'))
                                                        <span class="text-danger error-msg">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="code_postal" id="code_postal"
                                                               class="mt-m15 form-control" value="{{old('code_postal')}}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="5" name="description" id="description" class="mt-m15 form-control">{{old('description')}}</textarea>
