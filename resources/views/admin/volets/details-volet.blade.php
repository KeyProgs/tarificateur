                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a title="Supprimer" class="confirm-delete"
                                               data-href="{{url('/volet/'.$volet->id.'/sous-volet/'.$sousVolet->id.'/suppression')}}">
                                                <i class="icon-trash">
                                                </i>
                                            </a>
                                            &nbsp;&nbsp;
                                            <a title="Voir les details" href="{{url('/volet/'.$volet->id.'/sous-volet/'.$sousVolet->id)}}">
                                                <i class="icon-eye2"></i>
                                            </a>
                                        </td>
                                    </tr>
