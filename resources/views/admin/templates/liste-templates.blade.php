            ...
            <div class="content-wrapper">
                ...
                <div class="page-header page-header-default ">
                    <div class="page-header-content hidden">
                        <div class="page-title">
                            <h4>
                                ...
                                <span class="text-semibold">Gestion des templates </span>
                            </h4>
                        </div>
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            <li>
                                <a href="{{url('/admin/fiches')}}"><i class="icon-home2 position-left"></i> Accueil
                                </a>
                            </li>
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">
                                <button onclick="window.location.href='{{url('/templates/nouvelle')}}'"
                                        class="rounded0 text-white btn btn-primary btn-xs-custom">
                                    <i class="icon-plus-circle2"></i> Ajouter une template
                                </button>
                            </h5>
                        ...
                        <table class="table basic-datatable">
                            ...
                            @foreach($templates as $template)
                                <tr>
                                    <td width="10%">{{$template->id}}</td>
                                    <td width="60%">{{$template->nom}}</td>
                                    <td class="hidden">&nbsp;</td>
                                    <td class="hidden">&nbsp;</td>
                                    <td class="hidden">&nbsp;</td>
                                    <td class="text-center">
                                        <a title="Supprimer" class="confirm-delete"
                                           data-href="{{url('/templates/'.$template->id.'/suppression')}}">
                                            <i class="icon-trash"></i>
                                        </a>
                                        &nbsp;&nbsp;
                                        <a title="Voir les details" href="{{url('/templates/'.$template->id)}}">
                                            <i class="icon-eye2"></i>
                                        </a>
                                    </td>
                                </tr>
