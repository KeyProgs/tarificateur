                                            ...
                                            <div class="page-header page-header-default">
                                                <div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i
                                                    ...
                                                    <ul class="breadcrumb-elements hidden">
                                                        ...
                                                        <li>
                                                            <a href="#" class="legitRipple"><i class="icon-comment-discussion position-left"></i>
                                                                Support
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="row pt-15 pb-20">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger error-msg" id="error_provenance_id">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="date_effet" id="date_effet"
                                                                       class="mt-m15 form-control pickadate-translated"
                                                                       value="{{date('Y/m/d')}}">
