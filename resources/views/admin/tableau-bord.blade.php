    ...
    <div class="page-container">
        ...
        <!-- Main content -->
            <div class="content-wrapper">
                                    ...
                                    <div class="media no-margin">
                                        <div class="media-body">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" required name="date_debut" id="date_debut"
                                                       class="date-picker mt-m15 form-control"
                                                       value="{{old("date_debut")}}">
                                                <span class="text-danger error-msg" id="error_date_debut">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" required name="date_fin" id="date_fin"
                                                       class="date-picker mt-m15 form-control"
                                                       value="{{old("date_fin")}}">
                                                <span class="text-danger error-msg" id="error_date_fin">
                                                   <strong class="text-danger"></strong>
                                            </span>
                                            </div>

                                            <div class="col-md-4">
                                                <button type="submit" class="mt-1 btn btn-primary btn-block rounded-0">
                                                    Filtrer
                                                </button>
                                            </div>
                                        </div>
                ...
                @include('includes.admin.historique')
