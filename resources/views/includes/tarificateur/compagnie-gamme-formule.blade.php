...
<div style="float: left">
    <select name="devis_id" id="devis_id" style="height: 25px;width: 200px !important;">
        <optgroup label="Nouvelle Contrat">
            <option selected value="">Nouvelle Contrat</option>
        </optgroup>
        <optgroup label="Modifier un devis">
            @foreach($devis as $d)
                <option value="{{$d->id}}">Devis N° {{$d->id}}</option>
            @endforeach
        </optgroup>
    </select>
    <br>
    <span class="text-danger error-msg" id="error_devis_id">
...
<div style="float: left">
    ...
    <br>
    <span class="text-danger error-msg" id="error_compagnie_id">
        <strong class="text-danger"></strong>
    </span>
</div>
...
<div style="float: left">
    ...
    <br>
    <span class="text-danger error-msg" id="error_gamme_id">
        <strong class="text-danger"></strong>
    </span>
</div>
