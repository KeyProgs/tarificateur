...
<div class="span2"><span class="companyLogo"><img src="test/logo/cgm_logo2.png" title="cgm_logo2.png" alt="cgm_logo2.png">&nbsp;</span></div>
...
<table border="1" style="border-width: medium; border: #0B1022" >
    <tr>
        <td>
            <form action="up_config" method="post" enctype="multipart/form-data">
