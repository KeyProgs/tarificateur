                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <img style="width: 120px;height: 100px"
                                                                 src="http://acsassurance.com/images/gammes/{{$gamme->nom}}.png"/>
                                                            ...
                                                            <table border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td width="auto" align="center"
                                                                        ...
                                                                        <a href="http://acsassurance.com/espace-client/u/client-verification-tkn/{{md5($prospect->id)}}/f-{{$fiche->id.'/devis-'.$devis->id.'/'.$formule->id}}" style="color: #ffffff; font-size: 12px; text-decoration: none; text-transform: uppercase; line-height: 32px;">Souscriree</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
