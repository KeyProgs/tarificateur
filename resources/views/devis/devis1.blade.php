                                                    ...
                                                    <tr>
                                                        <td height="60" valign="middle" width="100%" align="left">
                                                            <a href="#"><img width="125"
                                                                             src="{{asset('/global-assets/images/logo_light.png')}}"
                                                                             alt=""></a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                ...
                                                <table width="280" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td width="99%" align="center">
                                                            <a href="/client-verification/f-555/devis-17"
                                                               style="border-radius: 4px;background-color:#4f97e2;color: #ffffff; font-size: 18px; text-decoration: none;padding:6 22 6 22">
                                                                09.72.58.25.76
                                                            </a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <img style="width: 120px;height: 100px"
                                                                 src="{{asset('/uploads/img/gammes/'.$gamme->nom.'.png')}}"/>
                                                            ...
                                                            <table border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td width="auto" align="center"
                                                                        ...
                                                                        <a href="http://acsassurance.com/espace-client/c/client-verification-tkn/f-{{$fiche->id}}/devis-{{$devis->id}}/{{$formule->id}}"
