                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="date_effet" id="date_effet"
                                                                       ...
                                                                       value="{{@$data_predictif['date_effet']}}">
                                                                <span class="text-danger error-msg"
                                                                      id="error_date_effet">
                                                                      <strong class="text-danger"></strong>
                                                                </span>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="date_naissance"
                                                                       ...
                                                                       value="{{date("d/m/Y", strtotime(@$data_predictif['date_naiss'])) }}">
                                                                <span class="text-danger error-msg"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input data-mask="9-99-99-99-999-999-99" type="text"
                                                                       ...
                                                                       class="mt-m15 form-control"
                                                                       value="{{@$data_predictif['numero_securite_sociale']}}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input data-mask="999-999-999" type="text"
                                                                       ...
                                                                       class="mt-m15 form-control"
                                                                       value="{{@$data_predictif['numero_affiliation']}}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="code_postal" id="code_postal"
                                                                       class="mt-m15 form-control"
                                                                       value="{{@$data_predictif['code_postal']}}">
                                                                <span class="text-danger error-msg"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="ville_id" id="ville_id"
                                                                        class="mt-m15 bootstrap-select form-control form-control-sm"
                                                                        style="padding: 8px;">
                                                                    @if($data_predictif['code_postal'] != null)
                                                                        @php
                                                                            $ville = new \App\Details_personne();
                                                                            echo $ville->getVilleByCodePostal($data_predictif['code_postal']);
                                                                        @endphp
                                                                    @endif
                                                                </select>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input data-mask="+33 9-99-99-99-99" type="text"
                                                                       ...
                                                                       value="{{@$data_predictif['telephone']}}"
                                                                       class="mt-m15 form-control">
                                                                <span class="text-danger error-msg"
                                ...
                                <div class="panel panel-flat border-top-lg border-top-primary">
                                    ...
                                    <div class="panel-body p-10">
                                        <textarea class="form-control" name="commentaire"
                                                  id="commentaire">{{@$data_predictif['commentaire']}}</textarea>
                                    </div>
                                </div>
                                <button type="button" class="btn-block add_fiche btn btn-primary btn-xs rounded0">
                                    <b><i class="icon-database-insert"></i></b>&nbsp;&nbsp;&nbsp;Ajouter la fiche
                                </button>
                            </div>
