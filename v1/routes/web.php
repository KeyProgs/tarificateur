...
Route::post('/get-type-assurance-formules', 'TarificateurController@getTypeAssuranceFormules')->name('getTypeAssuranceFormules');
Route::get('/get-type-assurance-formules', 'TarificateurController@getTypeAssuranceFormules')->name('getTypeAssuranceFormules');
...
Route::post('/set-contrat-infos', 'DevisController@contratInfos');
...
Route::get('mail/{mail_id}', 'MailController@mailDetails');
