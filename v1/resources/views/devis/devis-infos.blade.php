                                                            ...
                                                            <table border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td width="auto" align="center"
                                                                        ...
                                                                        <a href="http://acsassurance.com/espace-client/c/{{md5($prospect->id)}}/f-{{$fiche->id.'/devis-'.$devis->id.'/'.$formule->id}}" style="color: #ffffff; font-size: 12px; text-decoration: none; text-transform: uppercase; line-height: 32px;">Souscrire</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
