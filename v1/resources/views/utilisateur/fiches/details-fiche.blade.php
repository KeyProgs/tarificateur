                            ...
                            <ul class="breadcrumb-elements">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="SIP:{{$fiche->personne->details->telephone_1}}@192.168.100.200"><i
                                                        class=" icon-phone-outgoing"></i> {{$fiche->personne->details->telephone_1}}
                                            </a></li>
                                        <li><a href="SIP:{{$fiche->personne->details->telephone_2}}@192.168.100.200"><i
                                                        class=" icon-phone-outgoing"></i> {{$fiche->personne->details->telephone_2}}
                                            </a></li>
                                        <li><a href="SIP:{{$fiche->personne->details->telephone_3}}@192.168.100.200"><i
