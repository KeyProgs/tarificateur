                        ...
                        <div class="panel-toolbar panel-toolbar-inbox">
                            <div class="navbar navbar-default">
                                ...
                                <div class="navbar-collapse collapse" id="inbox-toolbar-toggle-multiple">
                                    ...
                                    <div class="btn-group navbar-btn">
                                        <button type="button" class="btn btn-default"><i class="icon-pencil7"></i> <span class="hidden-xs position-right">Composer</span></button>
                                        <button type="button" class="btn btn-default"><i class="icon-bin"></i> <span class="hidden-xs position-right">Supprimer</span></button>
