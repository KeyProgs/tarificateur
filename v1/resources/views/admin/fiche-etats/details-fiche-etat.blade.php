            ...
            <div class="content-wrapper">
                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content hidden">
                        <div class="page-title">
                            <h4>
                                ...
                                <span class="text-semibold">Details Etat Fiche</span>
                            </h4>
                        </div>
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="{{url('/groupe-etats/'.$etat->groupe_etat->id)}}">
                                    {{$etat->groupe_etat->valeur}}
                                </a>
                            </li>
                            <li class="active">{{$etat->valeur}}</li>
                        </ul>
                ...
                <div class="content p0">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form action="{{url('/groupe-etats/'.$etat->groupe_etat->id.'/etat/'.$etat->id)}}"
                              method="post">
                            @csrf
                            ...
                            <div class="panel registration-form">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-feedback">
                                                <select name="etat_groupe_id" id="etat_groupe_id"
                                                        class="bootstrap-select form-control">
                                                    <option value="" disabled>Choisir le groupe d'etat</option>
                                                    @foreach($groupes_etats as $groupe)
                                                        <option @if($etat->groupe_etat->id==$groupe->id) selected
                                                                @endif value="{{$groupe->id}}">
                                                            {{$groupe->valeur}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                @if ($errors->has('etat_groupe_id'))
                                                    <span class="text-danger error-msg" role="alert">
                                                    <strong class="text-danger">{{ $errors->first('etat_groupe_id') }}</strong>
                                                </span>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" class="form-control" name="libelle" rows="5"
                                                      placeholder="Libelle">{{$etat->libelle}}</textarea>
