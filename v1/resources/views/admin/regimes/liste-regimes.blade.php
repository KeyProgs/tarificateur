                    ...
                    <div class="page-header-content hidden">
                        <div class="page-title">
                            <h4>
                                ...
                                <span class="text-semibold">Gestion des régimes </span>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">
                                <button onclick="window.location.href='{{url('/regimes/nouveau-regime')}}'"
                                        class="rounded0 text-white btn btn-primary btn-xs-custom"><i
                                            class="icon-plus-circle2"></i> Ajouter un régime
                                </button>
                            </h5>
                                    ...
                                    <td>
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a class="confirm-delete" data-href="{{url('/regime/'.$regime->id.'/suppression')}}"><i class="icon-trash"></i> Supprimer</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{url('/regime/'.$regime->id)}}">
