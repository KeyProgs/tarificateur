            ...
            <div class="content-wrapper">
                ...
                <div class="content p0">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form action="{{url('/templates/nouvelle')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="panel registration-form">
                                <div class="panel-body">
                                    <div class="text-center">
                                        ...
                                        <h5 class="content-group-lg">Template informations
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-9">
                                                ...
                                                <textarea type="text" cols="18" rows="10"
                                                          ...
                                                          name="template" rows="5" placeholder="Template">{{old('template')}}</textarea>
                                            ...
                                            <div class="col-md-3">
                                                <div class="col-md-12">
                                                    <div class="content-group">
                                                        ...
                                                        <ul class="list-group">
                                                            <li class="list-group-header text-center">Insertion des variables</li>
                                                            @foreach($vars as $i=>$v)
                                                                @if(@sizeof($v)>0)
                                                                    @foreach($v as $key => $value)
                                                                    <li data-variable="{{$key}}" class="template-variable cursor-pointer list-group-item">
                                                                        {{$key}}
                                                                    </li>
                                                                    @endforeach
                                                                @else
                                                                    <li data-variable="{{$i}}" class="template-variable cursor-pointer list-group-item">
                                                                        {{$i}}
                                                                    </li>
                                                                @endif
                                                            @endforeach
