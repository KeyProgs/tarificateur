...
<div class="modal-content rounded0">
                                    ...
                                    <div class="row pt-15 pb-20">
                                        <div class="col-md-12" id="">
                                            <div class="col-md-2 p0">
                                                ...
                                                <b>Mode de paiement</b><select name="mode_id" class="form-control">
                                            ...
                                            <div class="col-md-2">
                                                <b class="paiement-compte-Prelevement">
                                                    Date prélévement <select name="date_prelevement" class="form-control">
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn-save-devis rounded0 btn btn-primary">Enregistrer et Envoyer Devis</button>
    </div>
</div>